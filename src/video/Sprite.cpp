...
void Sprite::render(Renderer& renderer)
{
	...
	renderer.drawTexture(_pTexture, getPosition(),
						 Vector2i(_frameSize.x, _frameSize.y), getAngle(),
						 getScale(), Vector2f(frameXBeginf, frameYBeginf),
						 Vector2f(frameXEndf, frameYEndf));
}
//----------------------------------------------------------------------------//
